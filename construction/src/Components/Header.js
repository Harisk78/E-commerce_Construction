...
import Img1 from 'construction/public/Images/img1.jpg'
        ...
        <div className="container py-4">
            ...
            <div id="carouselExampleIndicators" className="carousel slide mb-4 slider" data-bs-ride="carousel">
                ...
                <div className="carousel-item active" data-bs-interval="3000">
                    <img src={''} className="d-block w-100" alt="Promo 1" />
                </div>
                <div className="carousel-item" data-bs-interval="3000">
                    <img src={Img1} className="d-block w-100" alt="Promo 2" />
                </div>
                <div className="carousel-item" data-bs-interval="3000">
                    <img src={''} className="d-block w-100" alt="Promo 3" />
                </div>
                </div>
