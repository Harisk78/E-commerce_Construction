  ...
  return (
    <>
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light shadow fixed-top">
        <div className="container-fluid d-flex flex-column">
          ...
          <div className="d-flex justify-content-between align-items-center w-100">
            <div>
              <h1 className="mb-0 text-center text-success slide-title">
                Materon
              </h1>
              <span className="text-primaryn slide-title">
                Built on Trust. Powered by Supply
              </span>
            </div>
            <button
          ...
          <div className="mt-2 w-100 d-lg-none px-3">
            <div className="dropdown">
              <button
                className="btn btn-secondary dropdown-toggle w-100 button"
                type="button"
              ...
              <ul className="dropdown-menu w-100">
                <li>
                  <Link className="dropdown-item button" to="/">
                    Home
                  </Link>
                </li>
                {products?.length > 0 ? (
          ...
          {isNavOpen && (
            <div className="w-100 d-lg-none px-3 mt-3">
              ...
              <button
                className="btn btn-outline-danger w-100 d-flex align-items-center justify-content-center gap-1 button"
          ...
          <div className="d-none d-lg-flex justify-content-end align-items-center gap-2 w-100 mt-2">
            ...
            <button
              className="btn btn-outline-danger d-flex align-items-center gap-1 button"
              onClick={handleLogout}
            >
              <ion-icon name="log-out-outline"></ion-icon> Logout
            </button>
      ...
      <div style={{ paddingTop: "200px", userSelect: "none" }} className="px-3">
        ...
        <div
          id="customCarousel"
          className="carousel slide mb-4 slider"
        ...
        <style>
          {`
            ...
            .carousel-control-prev {
              left: -30px; /* Push outside left */
            }

            .carousel-control-next {
              right: -30px; /* Push outside right */
            }
        ...
        <Routes>
          ...
          <Route
            ...
            element={<RelatedProducts searchQuery={searchQuery} />}
          />
